...
package org.springaicommunity.agents.claude.sdk.test;
...
public abstract class ClaudeCliTestBase {
	...
	static void discoverClaudeCli() {
		try {
			claudeCliPath = org.springaicommunity.agents.claude.sdk.config.ClaudeCliDiscovery.discoverClaudePath();
			logger.info("Claude CLI tests will use executable at: {}", claudeCliPath);
		}
		catch (org.springaicommunity.agents.claude.sdk.config.ClaudeCliDiscovery.ClaudeCliNotFoundException e) {
