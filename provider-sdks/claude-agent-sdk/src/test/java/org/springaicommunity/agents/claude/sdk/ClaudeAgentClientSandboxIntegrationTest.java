...
/**
 * Tests for new ClaudeAgentClient methods that support sandbox integration.
 *
 ...
 */
class ClaudeAgentClientSandboxIntegrationTest {
	...
	void setUp() throws Exception {
		...
		client = ClaudeAgentClient.create(defaultOptions, Paths.get("/tmp"), "/usr/bin/echo");
	}
