...
/**
 * Test class for ClaudeCodeClient functionality.
 *
 * <p>
 ...
 * </p>
 */
class ClaudeCodeClientIT extends ClaudeCliTestBase {

	@Test
	void testClientConnection() throws Exception {
		try (ClaudeCodeClient client = ClaudeCodeClient.create(CLIOptions.defaultOptions(), workingDirectory(),
				getClaudeCliPath())) {
			client.connect();
	...
	void testClientWithOptions() throws Exception {
		...
		try (ClaudeCodeClient client = ClaudeCodeClient.create(options)) {
			client.connect();
