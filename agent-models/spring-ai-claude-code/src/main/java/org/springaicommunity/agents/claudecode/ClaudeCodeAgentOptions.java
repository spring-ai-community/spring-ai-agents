...
public class ClaudeCodeAgentOptions implements AgentOptions {
	...
	public ClaudeCodeAgentOptions(String model) {
		this.model = model;
	}
	...
	/**
	 * Builder for ClaudeCodeAgentOptions.
	 */
	public static final class Builder {

		private final ClaudeCodeAgentOptions options = new ClaudeCodeAgentOptions();
		...
		public ClaudeCodeAgentOptions build() {
			return options;
		}
