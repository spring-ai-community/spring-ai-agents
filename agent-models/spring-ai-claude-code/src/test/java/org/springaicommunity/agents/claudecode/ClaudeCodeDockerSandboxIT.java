...
/**
 * TCK test implementation for ClaudeCodeAgentModel with DockerSandbox.
 *
 * <p>
...
class ClaudeCodeDockerSandboxIT extends AbstractAgentModelTCK {
	...
	void setUp() {
		try {
			...
			ClaudeCodeClient claudeApi = ClaudeCodeClient.create(CLIOptions.defaultOptions(), sandbox.workDir());
