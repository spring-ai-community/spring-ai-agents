...
Voting strategies determine how individual judgments aggregate. See xref:judges/jury/voting-strategies.adoc[Voting Strategies] for complete details.
...
* **Voting Strategies**: xref:judges/jury/voting-strategies.adoc[Complete voting strategy reference]
...
* **Deterministic Judges**: xref:judges/deterministic/overview.adoc[Fast, objective evaluation]
