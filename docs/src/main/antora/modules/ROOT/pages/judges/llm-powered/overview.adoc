...
See xref:judges/llm-powered/correctness-judge.adoc[CorrectnessJudge] for complete details.
...
* **CorrectnessJudge**: xref:judges/llm-powered/correctness-judge.adoc[Built-in semantic correctness evaluation]
