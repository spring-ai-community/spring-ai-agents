...
* **Agent SDK portability layer** - Java wrappers for leading agentic CLI tools: xref:api/claude-code-sdk.adoc[Claude Agent SDK], xref:api/gemini-cli-sdk.adoc[Gemini CLI Agent SDK], xref:api/amp-cli-sdk.adoc[Amp CLI SDK], https://github.com/SWE-agent/mini-swe-agent[mini-swe-agent], with planned support for https://block.github.io/goose/[Goose], https://github.blog/news-insights/product-news/github-copilot-meet-the-new-coding-agent/[GitHub Copilot Agent], https://aws.amazon.com/q/developer/[Amazon Q Developer], and https://openai.com/index/introducing-upgrades-to-codex/[OpenAI Codex]
