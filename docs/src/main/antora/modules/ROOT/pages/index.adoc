...
* **Safety layers** - xref:concepts/sandboxes.adoc[Sandboxes], permissions, monitoring
...
We're building https://github.com/spring-ai-community/spring-ai-bench[**Spring AI Bench**]—an open-source benchmark suite for Java that evaluates agents on goal-directed, enterprise workflows. Following BetterBench best practices for reproducibility and contamination resistance.
...
* **Safety and observability** - xref:concepts/sandboxes.adoc[Sandboxes], permissions, monitoring
