...
* xref:api/amp-cli-sdk.adoc[Amp Agent SDK] - Java integration with Sourcegraph Amp
* xref:api/codex-cli-sdk.adoc[Codex Agent SDK] - Java integration with OpenAI Codex
* xref:api/amazon-q-cli-sdk.adoc[Amazon Q Developer Agent SDK] - Java integration with Amazon Q Developer
